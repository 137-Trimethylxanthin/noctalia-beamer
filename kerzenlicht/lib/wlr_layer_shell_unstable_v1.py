...
from pywayland.protocol.xdg_shell import XdgPopupProxy
...
class ZwlrLayerShellV1Resource(Resource[ZwlrLayerShellV1]):
    interface = ZwlrLayerShellV1


class ZwlrLayerSurfaceV1Resource(Resource[ZwlrLayerSurfaceV1]):
...
class ZwlrLayerShellV1Proxy(Proxy[ZwlrLayerShellV1]):
    ...
    def get_layer_surface(self, surface: WlSurfaceProxy, output: WlOutputProxy | None, layer: int, namespace: str) -> ZwlrLayerSurfaceV1Proxy:
...
class ZwlrLayerSurfaceV1Proxy(Proxy[ZwlrLayerSurfaceV1]):
    ...
    def get_popup(self, popup: XdgPopupProxy) -> None:
...
class ZwlrLayerShellV1Global(Global[ZwlrLayerShellV1]):
    interface = ZwlrLayerShellV1


class ZwlrLayerSurfaceV1Global(Global[ZwlrLayerSurfaceV1]):
    interface = ZwlrLayerSurfaceV1
